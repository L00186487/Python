...
I’ve added an import to the sys and os libraries.
I’m going to define global variables which I can use anywhere in the code.
I am going to exit the programme unless I detect Windows or Linux.
I have added a simple function to get my working path and print it for diagnostics.
