...
# When we create variables in any programming language, they are normally the concatenation 
# of the variable and its namespace. We say that a variable has scope. 
my_string = "global"
